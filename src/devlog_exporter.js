...
FTFetch(document.querySelector(".project-card__banner-image").src)
// Firefox catch-safe
function FTFetch(url) {
    return fetch(url, {headers: {"X-Flavortown-Ext-20313": true}})
}
...
function createExportButton(showDialog) {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="512" height="512" fill="none">
